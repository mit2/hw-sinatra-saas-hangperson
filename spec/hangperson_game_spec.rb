...
describe HangpersonGame do
  ...
  #-------------------------------------------------------------------------(0)---- 
  # The describe 'new' block means "the following block of tests describe the behavior of a 'new' HangpersonGame instance." 
  # The hangpersonGame line causes a new instance to be created, and the next lines verify the presence and values of instance variables.
  describe 'new' do
